...
![Img](./media/img-20240614132522.png)

红色LED模块上的LED点亮。

![Img](./media/img-20240614132547.png)
...
| ![img](media/KS5016.png)|![img](media/KE4005.png)|![img](media/USB.jpg)  | 
| ---------------------------- | ---------------------------- | ------------------------ |
|主板 x1 | 红色蝌蚪模块 x1 | USB线  x1 |
|  ![img](media/KE4064.png) |![img](media/3pin.png)|      | 
| 旋转电位器 x1      |3P线(反向) x2 |     |
...
![Img](./media/img-20240614135647.png)

这是映射指令方块，可以将一个取值范围映射到另一个取值范围。

![Img](./media/img-20240614135724.png)
...
![Img](./media/img-20240614102843.JPG)
...
![Img](./media/img-20240614143657.png)
